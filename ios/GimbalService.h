...
/**
 * Enables / disables the creation of an Airship CustomEvent upon place entry.
 * Tracking is enabled by default.
 */
- (void)setShouldTrackCustomEntryEvents:(BOOL)shouldTrack;

/**
 * Enables / disables the creation of an Airship CustomEvent upon place exit.
 * Tracking is enabled by default.
 */
- (void)setShouldTrackCustomExitEvents:(BOOL)shouldTrack;

/**
 * Enables / disables the creation of an Airship RegionEvent upon place entry
 * and exit. Tracking is disabled by default, since RegionEvents are deprecated
 * in favor of CustomEvents.
 */
 ...
 */
@property(nonatomic, assign, getter=isBluetoothPoweredOffAlertEnabled)
    BOOL bluetoothPoweredOffAlertEnabled;
...
/**
 * Associates a User Analytics Identifier with an application instance.  This
 * may be used to enrich exported analytics events from Gimbal Manager.
 *
